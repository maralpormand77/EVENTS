...
const APP_CONFIG = {
    ...
    events: {
        ...
        "kavir-varzaneh": {
            ...
            category: "رویداد علمی تفریحی",
            fullTitle: "تور کویر ورزنه - رویداد علمی تفریحی گروه توسعه سرمایه گذاری انتخاب",
            ...
            notes: [
                "مهلت ثبت نام نهایتا تا ساعت 13:00 روز یکشنبه مورخ 1405/06/22 می باشد.",
